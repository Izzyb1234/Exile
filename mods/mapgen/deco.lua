...
local decoration_list = {
    ...
    { --[[ All barren: Tsaplop                     ]]    "nodes_nature:tsaplop"              , "simple"   , all_barren_on                      , nil,           80,     0.000150,  nil                                                                                                              ,     highland_max,     beach_max, "nodes_nature:tsaplop"          , nil          , nil,         nil                  , nil                             ,      nil,   0,   nil, },
