...
---- Wetlands
  ...
  { --[[ rich forest: merki                      ]]    "fr_nn:merki"                     , "simple"   , rich_forest_on                          , nil,           16,     nil     ,  {offset =  0.00, scale = 0.0200, spread = {x =  32, y =  32, z =  32}, seed =   1112, octaves = 2, persist = 0.7},    highland_max,   lowland_max, "nodes_nature:merki"               , nil          , nil,         nil                  , nil                             ,      nil,   2,   nil, },
 ...
 ---- Barrenland & Duneland
  { --[[  Duneland: alaf - highland              ]]    "nodes_nature:alaf"               , "simple"   , duneland_on                        , nil,           80,     0.0800000,  nil                                                                                                              ,      highland_max,     upland_max, "nodes_nature:alaf"                , nil          , nil,         nil                  , nil                             ,      nil,   4,   nil, },
...
----All Soils
  ...
  { --[[  all: moss                              ]]    "all_nn:moss"                     , "simple"   , badland_soils_on                       , nil,           80,     0.000300,  nil                                                                                                              ,       highland_max,     beach_max, "nodes_nature:moss"             , nil          , nil,         nil                  , nil                             ,      nil, nil,   nil, },
...
----Eggs
  ...
  { --[[   Animals: kubwakubwa badlands           ]]    "animals:kubwakubwa_eggs_forest"        , "simple"   , badland_soils_on            , nil,           80,     0.000500,  nil                                                                                                                      ,       highland_max,         coastal_max, "animals:kubwakubwa_eggs"         , nil          , nil,         nil                  , "all_floors"                    ,      nil, nil,   nil, },
  ...
  { --[[   Animals: pegasun - badlands           ]]    "animals:pegasun_eggs"            , "simple"   , badland_soils_on                       , nil,           16,     nil     ,  {offset =  0.00, scale = 0.0015, spread = {x = 64, y = 64, z = 64}, seed =   1882, octaves = 2, persist = 2},             upland_max,    beach_max, "animals:pegasun_eggs"            , nil          , nil,         nil                  , "all_floors"                    ,      nil, nil,   nil, },
  ...
  { --[[   Animals: sneachan - badlands          ]]    "animals:sneachan_eggs"           , "simple"   , badland_soils_on                       , nil,           80,     0.004000,  nil                                                                                                              ,      highland_max,    beach_max, "animals:sneachan_eggs"           , nil          , nil,         nil                  , "all_floors"                    ,      nil, nil,   nil, },
